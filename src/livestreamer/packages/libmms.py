...
from ctypes import (c_char_p, c_double, c_int, c_longlong, c_uint, c_void_p,
                    cdll, create_string_buffer)

from ..compat import is_win32

if is_win32:
    libmms = cdll.LoadLibrary("libmms-0.dll")
else:
...
class MMS:
    ...
    def read(self, size=1024):
        ...
        count = libmms.mmsx_read(0, self.mms, buffer, size)
        if count < 0:
